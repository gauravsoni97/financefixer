...
const BalanceStats = ({}) => {
  return (
    <>
      <hr class="h-px my-4 bg-gray-100 border-0 dark:bg-gray-700 max-w-md" />
      <div className="flex item-center justify-between max-w-md">
      ...
      <hr class="h-px my-4 bg-gray-100 border-0 dark:bg-gray-800 max-w-md" />
    </>
  );
};
